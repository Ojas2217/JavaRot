...
public class JavaRotParser extends Parser {
	...
	public static final int
		T__0=1, VAR=2, INT=3, WS=4;
	public static final int
		RULE_program = 0, RULE_statement = 1, RULE_let = 2;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "statement", "let"
		};
	}
	...
	public static class LetContext extends ParserRuleContext {
		public TerminalNode VAR() { return getToken(JavaRotParser.VAR, 0); }
		public TerminalNode INT() { return getToken(JavaRotParser.INT, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof JavaRotListener ) ((JavaRotListener)listener).enterLet(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof JavaRotListener ) ((JavaRotListener)listener).exitLet(this);
		}
	}
